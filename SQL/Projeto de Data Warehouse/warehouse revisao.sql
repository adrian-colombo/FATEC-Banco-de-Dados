...
SELECT LIVRARIA.ID_LIVRARIA, VENDA.ID_ASSUNTO, LOCAL.ID_LOCAL, SUM(VENDA.VALOR) AS VALOR_TOTAL
FROM VENDA
INNER JOIN LIVRARIA ON VENDA.ID_LIVRARIA = LIVRARIA.ID_LIVRARIA
INNER JOIN LOCAL ON VENDA.ID_LOCAL = LOCAL.ID_LOCAL
GROUP BY LIVRARIA.ID_LIVRARIA, VENDA.ID_ASSUNTO, LOCAL.ID_LOCAL
ORDER BY VENDA.ID_ASSUNTO, LIVRARIA.ID_LIVRARIA;
